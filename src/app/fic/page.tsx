...
import { FICImageGallery } from '@/components/fic/FICImageGallery';
...
export const metadata: Metadata = {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `${BASE_URL}/fic/DSC01989.jpg.jpeg`,
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      images: [`${BASE_URL}/fic/DSC01989.jpg.jpeg`],
      creator: '@cedat_org',
    },
};
    ...
    <div className="min-h-screen bg-background text-foreground">
      <main className="pt-20 pb-20">
        <div className="container mx-auto px-4">
          ...
          {/* Top Image */}
          <div className="max-w-4xl mx-auto my-6 md:my-12">
            <div className="aspect-[16/9] sm:aspect-[16/7] rounded-3xl overflow-hidden border-2 border-border shadow-lg">
              <Image 
                src="/fic/DSC01989.jpg.jpeg" 
            ...
            <div className="md:col-span-2">
              <div className="bg-muted/30 p-6 rounded-2xl border border-border sticky top-24">
                ...
                <Button asChild size="lg" className="w-full font-bold text-lg">
                    <Link href="https://form.svhrt.com/69e5b6ed001e39939dd3b51a" target="_blank">
                        Register Now
                    </Link>
                </Button>
